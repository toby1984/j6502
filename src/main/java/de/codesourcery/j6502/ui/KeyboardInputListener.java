...
public class KeyboardInputListener extends KeyAdapter 
{
    ...
    private volatile JoyDirection joyDirection = JoyDirection.CENTER;
    private volatile boolean joyFire = false;

    public KeyboardInputListener(EmulatorDriver driver) 
    {
        this.driver = driver;
    }
    ...
    private void joystickChanged() 
    {
        driver.invokeAndWait(emulator -> 
        {
            // TODO: Access to joystickPort / joyDirection / joyFire is not atomic
            // TODO: so this code might see inconsistent states when another
            // TODO: thread mutates them in the meantime...
            switch ( joystickPort ) 
            {
                case PORT_1:

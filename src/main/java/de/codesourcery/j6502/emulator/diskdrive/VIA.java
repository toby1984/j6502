...
public class VIA extends Memory {
     ...
     * bit 6  
     * bit 5
     * bit 4 - shift register control
     * bit 3 - shift register control
     * bit 2 - shift register control
     * bit 1 - port B latching (CA1) 0 = disable, 1 = enable
     * bit 0 - port A latching (CB1) 0 = disable, 1 = enable
     * 
     * |4|3|2| *** shift register control ***
     * |0|0|0| SR disabled
